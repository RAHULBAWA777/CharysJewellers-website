...
const HallmarkSkeletonData = [

    {
        ...
        Hallmarkcaption:"BIS Hall Mark Jewellery",
        Hallmarkpara:"Now, here is the most important surety for you! Our gold is certified by the BIS hallmark as well! The Indian government has initiated the hallmark of the BIS mark on jewellery to ensure reliability and trust in the right quality and purity.There you go! Now you can rest assured, our gold, and diamonds, and all gems in between are all original and certified."
    },
    {
        id:2,
        hallmarkimage:SGL,
